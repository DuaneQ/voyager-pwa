...
describe('VideoGrid', () => {
  ...
  const mockVideos: Video[] = [
    ...
    },
    {
      ...
      likes: ['user-1'],
      comments: [
        { id: 'c1', userId: 'user-1', text: 'Great!', createdAt: Timestamp.now() },
        { id: 'c2', userId: 'user-2', text: 'Nice!', createdAt: Timestamp.now() },
        { id: 'c3', userId: 'user-3', text: 'Cool!', createdAt: Timestamp.now() }
      ],
      viewCount: 25,
      duration: 45,
